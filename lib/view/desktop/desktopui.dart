...
import 'package:dashboard_dcall/view/desktop/dashboardbody.dart';
import 'package:dashboard_dcall/view/desktop/doctoradd.dart';
...
import '../../../../view/desktop/paitentbag.dart';
import '../../../../view/desktop/requestview.dart';
import '../tab/logout_dialog.dart';
import 'about.dart';
import 'bloodbag.dart';
        ...
        body: Obx(
          () => Row(
            children: [
              Expanded(
                ...
                child: Container(
                  padding: EdgeInsets.symmetric(
                      vertical: MediaQuerypage.safeBlockVertical! * 1.22,
              ...
              Expanded(flex: 7, child: screenchange[viewselect.value])
            ],
          ),
        ),
      ),
