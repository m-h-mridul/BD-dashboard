            ...
            Column(children: [
              Column(
                ...
                children: [
                  ...
                  Container(
                    child: Center(
                      child: Text(
                          controller.hospitaldata.value.hispitalName.toString(),
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Container(
                  child: Center(
                    child: Text(
                        controller.hospitaldata.value.contact.toString(),
                        textAlign: TextAlign.start,
                        style: TextStyleManager.black18),
                  ),
                  padding: EdgeInsets.symmetric(
                  ...
                  decoration: BoxDecoration(
                    color: Colors.white,
                    borderRadius: BorderRadius.all(SizeManager.circularradius),
                    boxShadow: [
                      BoxShadow(
                        color: Colors.grey.withOpacity(0.5),
                        spreadRadius: 5,
