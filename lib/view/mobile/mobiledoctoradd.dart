...
class MobileDoctorAdd extends StatelessWidget {
  MobileDoctorAdd({Key? key}) : super(key: key);
                ...
                child: Padding(
                  ...
                  child: Container(
                    width: MediaQuerypage.screenWidth! *
                        0.3, // MediaQuerypage.screenWidth! * 0.15,
  ...
  InkWell imageget() {
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border.all(),
          borderRadius: BorderRadius.circular(CallingName.boxradius*3),
